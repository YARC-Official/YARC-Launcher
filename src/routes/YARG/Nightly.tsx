...
function NightlyYARGPage() {
    ...
    return (<>
        <LaunchPage version={yargVersion} releaseTag={releaseData?.tag_name} playName="NIGHTLY" description={<>
        ...
        </>} websiteUrl="https://github.com/YARC-Official/YARG-BleedingEdge" icon={NightlyYARGIcon} />
    </>);
}
